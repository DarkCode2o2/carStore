...
@section('content')
        ...
        <div class="create_car pt-20 pb-96 ms:px-0 px-2">
            <div class="max-w-6xl mx-auto mt-11">
                <form action="/manageCar/{{$car->id}}" class="myForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
...
...
...
..." required>{{old('car_description') ?? $car->car_description}}</textarea>
                    ...
                    <div>
                        ...
                        @livewire('deleteImage', ['carType' => 'cars', 'carid' => $car->id])
