...
@section('content')
        ...
        @endif
        <a href="/manageCar/create" class="bg-blue-600 hover:bg-blue-700 transition text-white py-2 px-4 rounded-lg fixed bottom-10 right-10 shadow-blue-300 shadow-lg z-50
                        ...
                        <tbody>
                            ...
                            @foreach ($cars as $car)
                                <tr class="bg-white border-b  hover:bg-gray-50">
                                    ...
                                    <td class="px-4 text-right">
                                        @livewire('updateColumn', ['data' => $car->id, 'status' => $car->car_status, 'part' => 'car'])                                    
                                    </td>
                                    <td class="px-4 text-right delete-td flex justify-cente items-center gap-2 h-[120px]">
                                        
                                        <a href="/manageCar/{{$car->id}}/edit" class="text-xl font-medium text-blue-500 hover:text-blue-800 transition underline"><i class="fa-regular fa-pen-to-square"></i></a>
                                        <form action="/manageCar/{{$car->id}}" method="POST" class="delete-form" onsubmit="return confirmDelete()">
                                            @csrf
                                            @method('DELETE')
